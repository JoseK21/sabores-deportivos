      ...
      <div className="flex h-screen overflow-hidden">
        <Sidebar
          ...
          items={[
            {
              title: "Dashboard",
              href: "/qs-staff-rest/admin-rest",
              label: "Dashboard",
            },
            {
              title: "User",
              href: "/qs-staff-rest/admin-rest/user",
              label: "user",
            },
            {
              title: "Employee",
              href: "/qs-staff-rest/admin-rest/employee",
              label: "employee",
            },
            {
              title: "Profile",
              href: "/qs-staff-rest/admin-rest/profile",
              label: "profile",
            },
            {
              title: "Kanban",
              href: "/qs-staff-rest/admin-rest/kanban",
              label: "kanban",
            },
            {
              title: "Login",
