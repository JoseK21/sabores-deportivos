interface DistrictsByCanton {
  [key: string]: string[]; // Agregar una firma de índice para permitir el acceso por string
}

interface CantonsByProvinces {
  [key: string]: DistrictsByCanton; // Agregar una firma de índice para permitir el acceso por string
}

export const PROVINCE_WITH_CANTONS: CantonsByProvinces = {
  "San José": {
    "San José": [
      "Merced",
      "Hospital",
    ...
    Escazú: ["Escazú", "San Antonioes", "San Rafaeles"],
    Desamparados: [
      "Desamparados",
      "San Miguel",
      "San Juan de Dios",
    ...
    Turrubar: ["San Pablo", "San Pedro", "San Juan de Mata", "San Luis", "Carara"],
  ...
  Guanacaste: {
    ...
    Abangares: ["Las Juntases", "Sierraes", "San Juanes", "Coloradoes"],
    Tilarán: [
      "Tilarán",
      "Quebrada Grande",
      "Tronadora",
